...
urlpatterns=[
	...
	path('noviceDeposit/', views.noviceDeposit, name='noviceDeposit'),
	path('amateurDeposit/', views.amateurDeposit, name='amateurDeposit'),
	path('superiorDeposit/', views.superiorDeposit, name='superiorDeposit'),
	path('mining_loanDeposit/', views.mining_loanDeposit, name='mining_loanDeposit'),
	path('amazingofferDeposit/', views.amazingofferDeposit, name='amazingofferDeposit'),
